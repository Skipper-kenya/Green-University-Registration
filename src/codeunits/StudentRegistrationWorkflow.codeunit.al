codeunit 50140 "Student  Workflow Mgmt"
{
    ...
    var
        ...
        WorkflowEventHandling: Codeunit "Workflow Event Handling";
    begin
        RecRef.Open(Database::"Student Registration Form");
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONSENDFORAPPROVALCODE, RecRef), Database::"Student Registration Form",
          GetWorkflowEventDesc(WorkflowSendForApprovalEventDescTxt, RecRef), 0, false);
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONCANCELFORAPPROVALCODE, RecRef), DATABASE::"Student Registration Form",
          GetWorkflowEventDesc(WorkflowCancelForApprovalEventDescTxt, RecRef), 0, false);
    end;
    // subscribe

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Student  Workflow Mgmt", 'OnSendWorkflowForApproval', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Student  Workflow Mgmt", 'OnCancelWorkflowForApproval', '', false, false)]
    ...
    var
        LeaveApp: Record "Student Registration Form";
    begin
        case RecRef.Number of
            Database::"Student Registration Form":
                begin
                    RecRef.SetTable(LeaveApp);
                    LeaveApp.Validate("Enrollment Status", LeaveApp."Enrollment Status"::Open);
    ...
    begin
        case RecRef.Number of
            Database::"Student Registration Form":
                begin
                    RecRef.SetTable(LeaveApp);
                    LeaveApp.Validate("Enrollment Status", LeaveApp."Enrollment Status"::Pending);
                    LeaveApp.Modify(true);
                    Variant := LeaveApp;
                    IsHandled := true;
                end;
    ...
    begin
        case RecRef.Number of
            DataBase::"Student Registration Form":
                begin
                    RecRef.SetTable(LeaveApp);
                    ApprovalEntryArgument."Document No." := LeaveApp."Full Name";
                end;
        end;
    end;
    ...
    begin
        case RecRef.Number of
            DataBase::"Student Registration Form":
                begin
                    RecRef.SetTable(LeaveApp);
                    LeaveApp.Validate("Enrollment Status", LeaveApp."Enrollment Status"::Approved);
                    LeaveApp.Modify(true);
                    Handled := true;
                end;
        end;
